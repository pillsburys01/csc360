...
// In the pillsburys1_MyLinkedList class:
...
public class TestMyLinkedListForHW {
    public static void main(String[] args) {
        pillsburys1_MyLinkedList<String> stringList = new pillsburys1_MyLinkedList<String>();
        ...
        pillsburys1_MyLinkedList<Object> objectList = new pillsburys1_MyLinkedList<Object>();
        objectList.add(1);
        objectList.add(2);
        objectList.add(3);
        objectList.add(4);
